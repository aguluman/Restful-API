...
server.unifiedServer = function(req,res){
    ...
    //Get the headers as an object  n 
    ...
    req.on('end', function () {
       ...
       chosenHandler(data,function(statusCode,payload,contentType){
        ...
        debug(e);
        server.processHandlerResponse(res,method,trimmedPath, 500, {'Error': 'An unkonwn error has occurred'}, 'json');
    }
...
server.processHandlerResponse = function(res,method,trimmedPath,statusCode,payload,contentType){
    ...
    res.end(payloadString);
        ...
        //If the response is 200, print green otherwise print purple 
        if(statusCode == 200){
